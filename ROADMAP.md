...
- [x] 2026-02-16 — governance: local dependency/runtime-artifact hygiene hotfix (`gitignore-venv-pyc-coverage-v1`) applied in `.gitignore` (venv/.venv/env/ENV + pyc coverage).
